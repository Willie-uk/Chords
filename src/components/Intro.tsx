    ...
    <div className="container my-5">
      ...
      <div className="row mt-5">
        ...
        <p>
          ...
          They are of two types, White and Black. The white keys are 7 and black
          keys are 5, totaling up to 12 keys/notes.
        </p>
      </div>
      <div className="row mt-2">
        ...
        <p>
          The black notes also have names, but they depend on the direction, if
          ascending by notes, it acquires the word{" "}
          <span className="fw-bold">Sharp(#)</span> + the name of the key before
          it, if descending by notes, it acquires the word{" "}
        ...
        <div className="row mt-4">
          ...
          <div className="d-flex flex-column">
            ...
            <p className="text-i text-center text-secondary">(H = Half-tone)</p>
          </div>
          <p>
