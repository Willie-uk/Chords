  ...
  return (
    <div className="container my-5">
      ...
      <div className="row mt-5">
        <h3>F# Major Scale</h3>
        <p>
          As stated earlier every key has its own solfa notations, using the Key
      ...
      <div className="row mt-5">
        <h3>F# Minor Scale</h3>
        <p>
          In the F# minor scale, the 3rd note, 6th note and 7th note are lowered
          down by a Semi-tone.
        </p>
        <div className="d-flex justify-content-around">
      ...
      <div className="row mt-5">
        ...
        <p>
          The Pentatonic scale consists of the 1st, 2nd, 3rd, 5th and 6th notes.
          Infact the F# pentatonic scale has no white key.
        </p>
        <div className="d-flex justify-content-around">
      ...
      <div className="row mt-5">
        <h3>F# Blues Scale</h3>
        <p>
          This is one of the most important musical scales, in the coming module
          you will learn how to use them, where to use them and how to convert
          them to chords, for now just practice as scale, use all octives to
          practice.
        </p>
        <div className="d-flex justify-content-around">
