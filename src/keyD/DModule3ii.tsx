...
import KWM16 from "../assets/Ci1.png";
import KWM17 from "../assets/Ci2.png";
import KWM18 from "../assets/Ci3.png";
import KWM19 from "../assets/Ci4.png";
import KWM20 from "../assets/Ci5.png";
import KWM21 from "../assets/Ci6.png";
import KWM22 from "../assets/Ci7.png";
import Lesson1 from "../links/Lesson1";
import { useNavigate } from "react-router-dom";
import { Download } from "lucide-react";
import myPdf from "../pdf/Piano-Lessons-Module3(ii) (1).pdf";

function DModule3ii() {
  const Navigate = useNavigate();
  const DM3ii = () => {
    Navigate("/Fsharp/module3/ii");
  };
  return (
    <>
      <Navbar />
        ...
        <div className="row">
          ...
          <div className="d-flex justify-content-center mt-4">
            ...
            <div className="ms-2">
              ...
              <a
                href={myPdf}
                download="Piano-Lessons-Module3(ii)-KeyD.pdf"
