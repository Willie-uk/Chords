...
import KWM9 from "../assets/Dr1.png";
import KWM10 from "../assets/Dr2.png";
import KWM11 from "../assets/Dr3.png";
import KWM12 from "../assets/Dr4.png";
import KWM13 from "../assets/Dr5.png";
import KWM14 from "../assets/Dr6.png";
import KWM15 from "../assets/Dr7.png";
import { ArrowBigLeft, ArrowBigRight } from "lucide-react";
import Lesson1 from "../links/Lesson1";
import { useNavigate } from "react-router-dom";
import { Download } from "lucide-react";
import myPdf from "../pdf/Piano-Lessons-Module3(i) (1).pdf";

function DModule3() {
  const Navigate = useNavigate();
  const DM3i = () => {
    Navigate("/Fsharp/module3");
  };
  return (
    <>
      <Navbar />
      ...
      <div className="container my-5">
        <div className="row">
          ...
          <div className="d-flex justify-content-center mt-4">
            ...
            <div className="ms-2">
              ...
              <a
                href={myPdf}
                download="Piano-Lessons-Module3(i)-KeyD.pdf"
        ...
        <div className="row mt-5">
          ...
          <p>
            If you look closely at the D scale, you see seven notes,
            <span className="fw-bold"> D-E-F#-G-A-B-C#</span>. each of these
