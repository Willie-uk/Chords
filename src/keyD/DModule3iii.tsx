...
import KWM23 from "../assets/Cl1.png";
import KWM24 from "../assets/Cl2.png";
import KWM25 from "../assets/Cl3.png";
import KWM26 from "../assets/Cl4.png";
import KWM27 from "../assets/Cl5.png";
import KWM28 from "../assets/Cl6.png";
import KWM29 from "../assets/Cl7.png";
import KWM30 from "../assets/DB1.png";
import KWM31 from "../assets/Cg1.png";
import KWM32 from "../assets/Cg2.png";
import KWM33 from "../assets/Cg3.png";
import Lesson1 from "../links/Lesson1";
import { useNavigate } from "react-router-dom";
import { Download } from "lucide-react";
import myPdf from "../pdf/Piano-Lessons-Module3(iii) (1).pdf";

function DModule3iii() {
  const [show, setShow] = useState(false);
  const Navigate = useNavigate();
  const DM3iii = () => {
    Navigate("/Fsharp/module3/iii");
  };
  return (
    <>
      <Navbar />
        ...
        <div className="row">
          ...
          <div className="d-flex justify-content-center mt-4">
            ...
            <div className="d-flex flex-column ms-3">
              ...
              <a
                href={myPdf}
                download="Piano-Lessons-Module3(iii)-KeyD.pdf"
